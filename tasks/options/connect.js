...
var config = {
  ...
  uaa: {
    clientId: 'login',
    serverUrl: 'https://daaf1a1b-e216-4f2a-aaa6-12188b35f91d.predix-uaa.run.aws-usw02-pr.ice.predix.io',
    defaultClientRoute: '/home',
    base64ClientCredential: 'bG9naW46QWJjQDQ0YWJj'
  },
  /**
  ...
  proxy: {
    '/api/view-service(.*)': {
      url: 'http://tms_view_instance.grc-apps.svc.ice.ge.com/api$1',
      instanceId: '5af6f8b3-1808-42ed-8422-5f414a762452'
    }
  }
};
